        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            if (rs.next()) {
                ...
                if (success) {
                    ...
                    searchParams.put("searchTitle", "");
                    searchParams.put("searchYear", null);
                    searchParams.put("searchDirector", "");
                    searchParams.put("searchStar", "");
                    searchParams.put("prefix", "");
                    searchParams.put("genre", "");
                    searchParams.put("limit", 10);
                    searchParams.put("offset", 0);
                    searchParams.put("sort", 0);
                    request.getSession().setAttribute("previousSearchParams", searchParams);
